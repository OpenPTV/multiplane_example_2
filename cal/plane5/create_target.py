...
z = -1500 # 3nd plane, /3DPTV_Illmenau/2025_03_05_Data_set/Target_Positions_BOI.pdf
...
import os
np.savetxt(os.path.join(os.path.dirname(__file__),'plane5.txt'), matrix, fmt='%4d\t%.2f\t%.2f\t%.2f')
